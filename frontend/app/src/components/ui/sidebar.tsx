    ...
    >
      ...
      >
        <div
          ...
          className="bg-sidebar group-data-[variant=floating]:border-sidebar-flex h-full w-full flex-col group-data-[variant=floating]: group-data-[variant=floating]:group-data-[variant=floating]:shadow-sm"
        >
          {children}
        </div>
      </div>
