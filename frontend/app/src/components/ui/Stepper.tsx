...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }: StepIndicatorProps) {
  ...
  return (
    <motion.div onClick={handleClick} className="step-indicator" animate={status} initial={false}>
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: '#f3f4f6', color: '#9ca3af' }, // Light gray
          active: { scale: 1, backgroundColor: '#6d28d9', color: '#fff' }, // Brand Purple
          complete: { scale: 1, backgroundColor: '#6d28d9', color: '#fff' } // Brand Purple
        }}
