...
const stats = [
  {
    ...
    subtext: "Sub-second finality via parallelized VMs.",
  },
  {
    value: "0%",
    label: "Slippage Tolerance",
    subtext: "Atomic execution protecting every trade.",
  },
  {
    value: "100K+",
    label: "TPS Infrastructure",
    subtext: "Massive throughput scaling for global alpha.",
  },
  {
    value: "Sub-Cent",
    label: "Gas Optimization",
    subtext: "Maximized capital efficiency with zero overhead.",
  },
];
